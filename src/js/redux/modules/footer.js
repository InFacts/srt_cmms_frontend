...
export const handleClickApproval = makeActionCreator(HANDLE_CLICK_APPROVAL);
export const handleClickSend = makeActionCreator(HANDLE_CLICK_SEND);
export const handleClickSave = makeActionCreator(HANDLE_CLICK_SAVE);
export const handleClickReject = makeActionCreator(HANDLE_CLICK_REJECT);
export const handleClickBack = makeActionCreator(HANDLE_CLICK_BACK);
export const handleClickCheckApproval = makeActionCreator(HANDLE_CLICK_CHECK_APPROVAL);
export const handleClickApprovalOrder = makeActionCreator(HANDLE_CLICK_APPROVAL_ORDER);
export const handleClickFastTrack = makeActionCreator(HANDLE_CLICK_FAST_TRACK);
export const handleClickApprovalProcess = makeActionCreator(HANDLE_CLICK_CANCEL_APPROVAL_PROCESS);
export const handleClickVoid = makeActionCreator(HANDLE_CLICK_VOID);
