...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case "ON CHANGE FILE":
      console.log("reducer", action.files)
      return {
        ...state,
        files: action.files
      }
    ...
    case "ON CHANGE SS101":
      // var clone_document_show = { ...state.document_show };
      // clone_document_show.refer_to_document_id = action.value;
      return {
        ...state,
        no_ss101: action.value
      }
    ...
    case "CLICK SELECT POPUP SS101":
      var clone_document_show = { ...state.document_show };
      clone_document_show.refer_to_document = action.value.document.internal_document_id;
      clone_document_show.refer_to_document_id = action.value.document.document_id;
      console.log("reducer", action.value)
      return {
        ...state,
        document_show: clone_document_show,
    ...
    case "ON CHANGE SS101 MODE ADD":
      // var clone_document_show_mode_add = { ...state.document_show_mode_add };
      // clone_document_show_mode_add.refer_to_document = action.value.document.internal_document_id;
      // clone_document_show_mode_add.refer_to_document_id = action.value.document.document_id;
      return {
        ...state,
        // document_show_mode_add: clone_document_show_mode_add
        no_ss101: action.value
    ...
    case "ON CLEAR STATE MODE ADD":
      ...
      return {
        ...
        no_ss101: initialState.no_ss101,
