                ...
                <div className="container_12 clearfix">
                    <section className="grid_12 ">
                        ...
                        <div style={{ height: "350px" }} id="blackground-white" style={changeTheam() === true ? { borderRadius: "25px", border: "2px dashed gray", height: "380px" } : { height: "380px" }}>
                            ...
                            <Link to="/pmt-equipment-master">
                                <div className="p-tooltip--btm-center edit" aria-describedby="btm-cntr" >
                                    <img alt='some value' src={changeTheam() === true ? OnetwoNew : Onetwo}
                                        className={changeTheam() === true ? "Pone-two-new" : "Pone-two"} style={changeTheam() === true ? { width: "50px" } : {}} />
                                    <span className="p-tooltip__message edit_p_tooltip__message Ptooltip4" role="tooltip" id="btm-cntr">PMT 4</span>
                                </div>
                            </Link>
                            ...
                            <Link to="/pmt-work-order">
                                <div className="p-tooltip--btm-center edit" aria-describedby="btm-cntr" >
                                    <img alt='some value' src={changeTheam() === true ? TwooneNew : Twoone}
                                        className={changeTheam() === true ? "Ptwo-one-new" : "Ptwo-one"} style={changeTheam() === true ? { width: "55px" } : {}} />
                                    <span className="p-tooltip__message edit_p_tooltip__message Ptooltip5" role="tooltip" id="btm-cntr">PMT 2</span>
                                </div>
                            </Link>

                            <Link to="/pmt-equipment-installation">
                                <div className="p-tooltip--btm-center edit" aria-describedby="btm-cntr" >
                                    <img alt='some value' src={changeTheam() === true ? TwotwoNew : Twotwo}
                                        className={changeTheam() === true ? "Ptwo-two-new" : "Ptwo-two"} style={changeTheam() === true ? { width: "70px" } : {}} />
                                    <span className="p-tooltip__message edit_p_tooltip__message Ptooltip7" role="tooltip" id="btm-cntr">PMT 6</span>
                                </div>
                            </Link>
                            ...
                            <Link to="/pmt-ss-101">
                                <div className="p-tooltip--btm-center edit" aria-describedby="btm-cntr" >
                                    ...
                                    <span className="p-tooltip__message edit_p_tooltip__message Ptooltip1" role="tooltip" id="btm-cntr">PMT 3</span>
                                </div>
                            </Link>
                            ...
                            <Link to="/pmt-fixed-asset">
                                <div className="p-tooltip--btm-center edit" aria-describedby="btm-cntr" >
                                    ...
                                    <span className="p-tooltip__message edit_p_tooltip__message Ptooltip2" role="tooltip" id="btm-cntr">PMT 9</span>
                                </div>
                            </Link>
                            ...
                            <Link to="/pmt-maitenant-item">
                                <div className="p-tooltip--btm-center edit" aria-describedby="btm-cntr" >
                                    <img alt='some value' src={changeTheam() === true ? FourtwoNew : Fourtwo}
                                        className={changeTheam() === true ? "Pfour-two-new" : "Pfour-two"} style={changeTheam() === true ? { width: "80px" } : {}} />
                                    <span className="p-tooltip__message edit_p_tooltip__message Ptooltip6" role="tooltip" id="btm-cntr">PMT 5</span>
                                </div>
                            </Link>
