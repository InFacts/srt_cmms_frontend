          ...
          <div id="general_content" className="tabcontent">
            ...
            <div className="container_12 mt-2">
              ...
              <div className="grid_4 pull_0">
                <SelectNoChildrenInput name="active" validate={values.modeEdit ? null : validateActionWarehouseIDField} cssStyle={{left: "-240px", top: "10px"}}
                  disabled={values.modeEdit ? false : props.toolbar.mode === TOOLBAR_MODE.SEARCH || props.toolbar.mode === TOOLBAR_MODE.JUST_SEARCH}  tabIndex="4">
                  {values.active === 1
                    ?
                    <>
                      {/* <option value=''></option> */}
            ...
            <div className="container_12 mt-2">
              <div className="container_12">
                ...
                <div className="grid_4 pull_0">
                  <TextInput name="location" validate={validateLocationWarehouseIDField} disabled={values.modeEdit ? false : props.toolbar.mode === TOOLBAR_MODE.SEARCH || props.toolbar.mode === TOOLBAR_MODE.JUST_SEARCH} tabIndex="5" />
                </div>
              </div>
              ...
              <div className="container_12">
                ...
                <div className="grid_4 pull_0">
                  <SelectNoChildrenInput name="warehouse_type_id" validate={validateWarehouseTypeIDField} cssStyle={{left: "-240px", top: "10px"}}
                    disabled={values.modeEdit ? false : props.toolbar.mode === TOOLBAR_MODE.SEARCH || props.toolbar.mode === TOOLBAR_MODE.JUST_SEARCH}  tabIndex="6">
                    <option value=''></option>
              ...
              <div className="container_12">
                ...
                <div className="grid_4 pull_0">
                  <SelectNoChildrenInput name="use_central"  validate={values.modeEdit ? null : validateUseCentralWarehouseIDField} cssStyle={{left: "-240px", top: "10px"}}
                    disabled={values.modeEdit ? false : props.toolbar.mode === TOOLBAR_MODE.SEARCH || props.toolbar.mode === TOOLBAR_MODE.JUST_SEARCH}  tabIndex="7">
