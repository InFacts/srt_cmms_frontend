...
const TopContent = (props) => {
  ...
  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(checkBooleanForEdit, DOCUMENT_TYPE_ID.INVENTORY_TRANSFER, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
