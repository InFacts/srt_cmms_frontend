...
const TopContent = (props) => {
  ...
  // Fill Default Forms
  useFillDefaultsOnModeAdd(DOCUMENT_TYPE_ID.INVENTORY_TRANSFER);

  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(decoded_token, checkBooleanForEdit, DOCUMENT_TYPE_ID.INVENTORY_TRANSFER, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
    ...
    <div id={changeTheam() === true ? "" : "blackground-white"}>
      ...
      <div className="container_12 clearfix">
        <section className="container_12 ">
          ...
          <div id={changeTheam() === true ? "blackground-white" : ""} style={changeTheam() === true ? { marginTop: "10px", borderRadius: "25px", border: "1px solid gray", height: "180px", paddingTop: "10px" } : {}} >
          ...
          <div className="container_12">
            ...
            <div className="grid_3 float-right">
              <TextInput name="dest_warehouse_id" validate={validateDestWarehouseIDField}
                disabled={checkBooleanForEdit === true ? false : toolbar.mode === TOOLBAR_MODE.SEARCH}
                searchable={checkBooleanForEdit === true ? true : toolbar.mode !== TOOLBAR_MODE.SEARCH} ariaControls="modalInventory2" tabIndex="5" />
            </div>
            <div className="grid_2 float-right">
