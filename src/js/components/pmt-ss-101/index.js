...
const PmtSS101Componant = (props) => {
    ...
    const [tabNames, setTabNames] = useState([
        { id: "breakdown", name: "อาการเสีย", is_active: TAB_BAR_ACTIVE.ACTIVE },
        { id: "related_partiesn", name: "ผู้ที่เกี่ยวข้อง", is_active: TAB_BAR_ACTIVE.INACTIVE },
        { id: "compensation_list", name: "รายการค่าเสียหาย", is_active: TAB_BAR_ACTIVE.INACTIVE },
        ...
        { id: "assets-under-maintenance", name: "สินทรัพที่ดำเดินการซ่อมบำรุง", is_active: TAB_BAR_ACTIVE.INACTIVE },
    ]);
