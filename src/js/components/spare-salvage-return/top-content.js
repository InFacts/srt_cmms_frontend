...
const TopContent = (props) => {
  ...
  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(DOCUMENT_TYPE_ID.SALVAGE_RETURN, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
