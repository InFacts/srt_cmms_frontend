...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case "CLICK SELECT POPUP INVENTORY":
      var clone_document_show = { ...state.document_show };
      clone_document_show.src_warehouse_name = action.value.name;
      clone_document_show.src_warehouse_id = action.value.warehouse_id;
      console.log("reducer", action.value)
      return {
        ...state,
        document_show: clone_document_show,
    ...
    case "CLICK SELECT POPUP INVENTORY MODE ADD":
      var clone_document_show_mode_add = { ...state.document_show_mode_add };
      clone_document_show_mode_add.src_warehouse_name = action.value.name;
      clone_document_show_mode_add.src_warehouse_id = action.value.warehouse_id;
      return {
        ...state,
        document_show_mode_add: clone_document_show_mode_add,
      }
