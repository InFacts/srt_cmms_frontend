...
const PopupModalUsername = (props) => {
  ...
  return (
    <div className="modal" id="modalUserNameResponesibleZoneBy" style={{ display: "none" }}>
      <div className="gray-board">
        ...
        <div className="container_12 edit-padding">
                  ...
                  return (
                    <tr key={index} id={index}>
                      ...
                      <td className="edit-padding text-center" style={{ minWidth: "150px" }}>
                        <button type="button" className="button-blue" onClick={() => setFieldValue('responsible_zone_by', line_users.employee_id, true)} aria-label="Close active modal" aria-controls="modalUserNameResponesibleZoneBy" id="closeModalInventory" >เลือก</button>
                      </td>
                    </tr>
                  )
                })}
          ...
          <button className="button-blue float-right grid_1 mr-5 mt-3" type="button" aria-label="Close active modal" aria-controls="modalUserNameResponesibleZoneBy" id="closeModalInventory">กลับ</button>
