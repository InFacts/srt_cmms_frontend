                  ...
                  return (
                    <tr key={index} id={index}>
                      ...
                      <td className="edit-padding text-center" style={{ minWidth: "150px" }}>
                        <button type="button" className="button-blue" onClick={() => setFieldValue('responsible_zone_by', line_users.user_id, true)} aria-label="Close active modal" aria-controls="modalUserNameResponesibleZoneBy" id="closeModalInventory" >เลือก</button>
                      </td>
                    </tr>
                  )
                })}
