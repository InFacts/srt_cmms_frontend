...
const PopupModalNoPart = (props) => {
    ...
    return (
        <div className="modal" id="modalEquipment" style={{ display: "none" }}>
            <div className="gray-board">
                ...
                <div className="container_12 edit-padding">
                                            ...
                                            <tr key={index} id={index}>
                                                ...
                                                <td className="edit-padding text-center" style={{ minWidth: "150px" }}>
                                                    <button type="button" className="button-blue"
                                                        ...
                                                        aria-label="Close active modal" aria-controls="modalEquipment" id="closeModalNoPart" >เลือก</button>
                                                </td>
                                            </tr>
                                        )
                                    } else {
                    ...
                    <button className="button-blue float-right grid_1 mr-5 mt-3" type="button" aria-label="Close active modal" aria-controls="modalEquipment" id="closeModalNoPart">กลับ</button>
