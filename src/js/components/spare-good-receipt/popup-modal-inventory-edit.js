...
const PopupModalInventoryEdit = ({props}) =>(
    <div className="modal" id="modalInventoryEdit" style={{ display: "none" }}>
        ...
        <div className="container_12 edit-padding">
            ...
            <div className="grid_8 pull_0">
                <input type="text" className="cancel-default grid_3" value={props.document_show.dest_warehouse_id} onChange={props.onChangeMyInventory} />
            </div>
            </div>
            <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">ชื่อคลัง</p></div>
            <div className="grid_8 pull_0">
                <input type="text" className="cancel-default grid_3" value={props.document_show.dest_warehouse_name} onChange={props.onChangeMyInventoryName} />
                <button className="button-blue edit grid_1 mr-5" type="button" onClick={(e) => props.onClickPopUpSearchInventory(props.document_show.dest_warehouse_id, props.document_show.dest_warehouse_name)}>ค้นหา</button>
            </div>
            </div>
            ...
            <table className="table-many-column mt-3">
                ...
                {props.inventory_show_popup.map(function (inventory_show_popup, index) {
                    ...
                    <tr key={index} id={index}>
                        ...
                        <button type="button" className="button-blue" onClick={props.onClickSelectInventoryModeEdit} aria-label="Close active modal" aria-controls="modalInventoryEdit" id="closeModalInventory" >เลือก</button>
                        </td>
                    </tr>
                    )
                })}
...
export default PopupModalInventoryEdit;