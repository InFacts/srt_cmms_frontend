  ...
  <div className="grid_12 edit-padding">
    ...
    <div className="grid_12">
      ...
      <div className="grid_8 pull_0">
        <input type="text" className="cancel-default grid_3" value={props.document_show_mode_add.created_by_user_name_th} onChange={props.onChangeNameModeAdd} />
      </div>
    </div>
    <div className="grid_12">
      <div className="grid_2"><p className="cancel-default">รหัสพนักงาน</p></div>
      <div className="grid_8 pull_0">
        <input type="text" className="cancel-default grid_3" value={props.document_show_mode_add.employee_id} onChange={props.onChangeNameIdModeAdd} />
        <button className="button-blue edit grid_1 mr-5" type="button" onClick={(e) => props.onClickPopUpSearchUser(props.document_show_mode_add.created_by_user_name_th, props.document_show_mode_add.employee_id)}>ค้นหา</button>
      </div>
    </div>
            ...
            return (
              <tr key={index} id={index}>
                ...
                <td className="edit-padding text-center" style={{ minWidth: "150px" }}>
                  <button type="button" className="button-blue" onClick={props.onClickSelectUser} aria-label="Close active modal" aria-controls="modalUserName" id="closeModalInventory" >เลือก</button>
                </td>
              </tr>
            )
          })}
