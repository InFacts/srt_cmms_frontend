...
class TopContent extends React.Component {
  ...
  componentDidMount() {
    ...
    if (document_id !== "") {
      console.log(document_id);
      this.props.approvalMode(document_id)
      // action_approval
    }
  ...
  checkAfterSearch = (created_by_user_name_th, document_status_id) => {
    if (created_by_user_name_th !== undefined && document_status_id === 1) {
        ...
        <>
          <div className="grid_12">
            ...
            <div className="grid_1 pull_1">
              {current.checkAfterSearch(current.props.document_show.created_by_user_name_th, current.props.document_show.document_status_id)}
            </div>
...
const mapDispatchToProps = (dispatch) => ({
  // Approval
  approvalMode: (e) => dispatch(approvalMode(e)),
...
export const approvalMode = (document_id) => {
...
export const onClickPopUpSearchInventory = (src_warehouse_id, src_warehouse_name) => {
  console.log("src_warehouse_id", src_warehouse_id, "src_warehouse_name", src_warehouse_name)
  return function (dispatch) {
    return axios.get(`http://${API_URL_DATABASE}:${API_PORT_DATABASE}/fact/warehouses?warehouse_id=${src_warehouse_id}&name=${src_warehouse_name}`, { headers: { "x-access-token": localStorage.getItem('token_auth') } }).then((res) => {
      console.log(res)
      dispatch({
