...
const TopContent = (props) => {
  ...
  // Fill Default Forms
  useFillDefaultsOnModeAdd(DOCUMENT_TYPE_ID.GOODS_ISSUE);

  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(decoded_token, checkBooleanForEdit, DOCUMENT_TYPE_ID.GOODS_ISSUE, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
  ...
  return (
    <div id={changeTheam() === true ? "" : "blackground-white"}>
      ...
      <PopupModalDocument documentTypeGroupID={DOCUMENT_TYPE_ID.GOODS_ISSUE}
