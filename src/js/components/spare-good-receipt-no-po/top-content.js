        ...
        <>
          ...
          <div className="grid_12">
            ...
            <div className="grid_3">
              <input type="text" className="cancel-default" defaultValue={current.props.document_show.refer_to_document_internal_document_id} disabled="disabled"></input>
            </div>
            <div className="grid_3 float-right">
      ...
      return (
        <>
          ...
          <div className="grid_12">
            ...
            <div className="grid_3">
              <input type="text" className="cancel-default" value={current.props.document_show.refer_to_document_internal_document_id} disabled="disabled"></input>
            </div>
            <div className="grid_3 float-right">
              <input type="text" className="cancel-default float-right" defaultValue={current.props.document_show.dest_warehouse_name} disabled="disabled"></input>
            </div>
