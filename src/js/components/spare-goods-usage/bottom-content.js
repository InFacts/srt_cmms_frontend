...
const BottomContent = (props) => {
  ...
  const validateLineNumberInternalItemIDField = (fieldName, internal_item_id, index) => new Promise(resolve => {
    ...
    console.log("validateLineNumberInternalItemIDField ------")
    if (values.line_items[index].internal_item_id === internal_item_id) {
      console.log("internal_item_id")
      console.log("values", values)
      console.log("return resolve ------", values.line_items[index].internal_item_id, "internal_item_id", internal_item_id)
      return resolve();
    }
    if (internal_item_id === "") {
      console.log("return internal_item_id = null")
