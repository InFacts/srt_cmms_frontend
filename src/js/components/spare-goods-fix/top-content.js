...
const TopContent = (props) => {
  ...
  // Fill Default Forms
  useFillDefaultsOnModeAdd(DOCUMENT_TYPE_ID.GOODS_FIX);

  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(decoded_token, checkBooleanForEdit, DOCUMENT_TYPE_ID.GOODS_FIX, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
