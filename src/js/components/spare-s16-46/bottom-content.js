                ...
                <>
                    ...
                    <div className="grid_12 mt-3">
                        ...
                        <div className="grid_4 pull_0">
                            <input type="text" className="cancel-default" defaultValue={this.props.document_show.account_type} disabled="disabled" />
                        </div>
            ...
            return (
                <>
                    ...
                    <div className="grid_12 mt-3">
                        <div className="grid_2"><p className="cancel-default">ประเภทบัญชี</p></div>
                        <div className="grid_4 pull_0">
                            <input type="text" className="cancel-default" defaultValue={this.props.document_show_mode_add.account_type} disabled="disabled" />
                        </div>
                        <div className="grid_3 float-right">
