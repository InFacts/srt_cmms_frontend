          ...
          <div className="grid_12 ">
            <div className="grid_12">
              <table className="table-many-column mt-3">
                ...
                <tbody>
                  {console.log("track_document_popup", props.track_document_popup)}
                  {props.track_document_popup.map(function (track_document_popup, index) {
                    return (
...
const mapStateToProps = (state) => ({
  ...
  track_document_popup: state.track_doc.temp_reducer.track_document_popup,
  track_document: state.track_doc.temp_reducer.track_document,
})
