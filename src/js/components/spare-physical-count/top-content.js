...
const TopContent = (props) => {
  ...
  // Fill Default Forms
  useFillDefaultsOnModeAdd(DOCUMENT_TYPE_ID.PHYSICAL_COUNT);

  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(decoded_token, checkBooleanForEdit, DOCUMENT_TYPE_ID.PHYSICAL_COUNT, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
