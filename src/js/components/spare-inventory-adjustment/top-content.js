...
const TopContent = (props) => {
  ...
  const validateInternalDocumentIDField = (...args) => validateInternalDocumentIDFieldHelper(DOCUMENT_TYPE_ID.INVENTORY_ADJUSTMENT, toolbar, footer, fact, values, setValues, setFieldValue, validateField, ...args)
