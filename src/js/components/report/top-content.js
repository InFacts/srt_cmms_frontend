        ...
        <>
          <div className="grid_12">
            ...
            <div className="grid_3 pull_0">
              <input className="cancel-default " type="text" disabled="disabled" value={this.props.report} />
            </div>
      ...
      return (
        <>
          <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">รายงาน</p></div>
            <div className="grid_3 pull_0">
              <input className="cancel-default " type="text" value={this.props.report} onChange={(e) => { this.props.onChangeReport(e) }} />
            </div>
            <div className="grid_2"><p className="cancel-default float-left">ระดับของรายงาน</p></div>
            <div className="grid_3 pull_0">
              <select className="edit-select-top" onChange={(e) => this.props.onChangeLevel(e)}>
                ...
                {this.props.level_list.map(function (level, index) {
                  if (current.props.level === level.type) {
                    ...
                    return <option value={level.type} key={index}> {level.type} </option>
                  }
                })}
              </select>
            </div>
          ...
          <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">ประเภทช่วงเวลา</p></div>
            <div className="grid_3 pull_0">
              <select className="edit-select-top" onChange={(e) => this.props.onChangeType(e)}>
                {this.props.type_list.map(function (type, index) {
                  if (current.props.type === type.type) {
                    return <option defaultValue={type.id} key={index} selected> {type.type} </option>
                  }
                  else {
                    return <option value={type.type} key={index}> {type.type} </option>
                  }
                })}
              </select>
            </div>
              ...
              <select className="edit-select-top" onChange={(e) => this.props.onChangeDistrict(e)}>
                {this.props.district_list.map(function (distric, index) {
                  if (current.props.distric === distric.name) {
                    ...
                    return <option value={distric.name} key={index}> {distric.name} </option>
                  }
                })}
              </select>
            </div>
              ...
              <select className="edit-select-top" onChange={(e) => this.props.onChangeYear(e)}>
                {this.props.year_list.map(function (year, index) {
                  if (current.props.year === year.type) {
                    ...
                    return <option defaultValue={year.id} key={index} > {year.type} </option>
                  }
                })}
              </select>
            </div>
              ...
              <select className="edit-select-top" onChange={(e) => this.props.onChangeStation(e)}>
                {this.props.station_list.map(function (station, index) {
                  if (current.props.station === station.name) {
                    ...
                    return <option defaultValue={station.id} key={index} > {station.name} </option>
                  }
                })}
              </select>
            </div>
              ...
              <select className="edit-select-top" onChange={(e) => this.props.onChangeMonth(e)}>
                {this.props.month_list.map(function (month, index) {
                  if (current.props.month === month.type) {
                    ...
                    return <option defaultValue={month.id} key={index} > {month.type} </option>
                  }
                })}
              </select>
            </div>
      ...
      return (
        <>
          <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">รายงาน</p></div>
            <div className="grid_3 pull_0">
              <input className="cancel-default " type="text" value={this.props.report_add} onChange={(e) => { this.props.onChangeReportAdd(e) }} />
            </div>
            <div className="grid_2"><p className="cancel-default float-left">ระดับของรายงาน</p></div>
            <div className="grid_3 pull_0">
              <select className="edit-select-top" onChange={(e) => this.props.onChangeLevelAdd(e)}>
          ...
          <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">ประเภทช่วงเวลา</p></div>
            <div className="grid_3 pull_0">
              <select className="edit-select-top" onChange={(e) => this.props.onChangeTypeAdd(e)}>
                {this.props.type_list.map(function (type, index) {
          ...
          <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">ปี</p></div>
            <div className="grid_3 pull_0">
              <select className="edit-select-top" onChange={(e) => this.props.onChangeYearAdd(e)}>
                {this.props.year_list.map(function (year, index) {
          ...
          <div className="grid_12">
            <div className="grid_2"><p className="cancel-default">เดือน</p></div>
            <div className="grid_3 pull_0">
              <select className="edit-select-top" onChange={(e) => this.props.onChangeMonthAdd(e)}>
                {this.props.month_list.map(function (month, index) {
