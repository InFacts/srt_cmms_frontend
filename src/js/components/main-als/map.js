                    ...
                    <div className="container_12 clearfix">
                        <section className="grid_12 ">
                            ...
                            <div style={{ height: "350px" }} id="blackground-white">
                                ...
                                <Link to="/als-equipment-status"><img alt='some value' src={Twoone} className="ALStwo-one" /></Link>
                                <img alt='some value' src={Text4} className="ALStext4" />
                                <Link to="/als-summary-ss101"><img alt='some value' src={Threeone} className="ALSthree-one" /></Link>
                                ...
                                <Link to="/als-plan-preventive-maintenance"><img alt='some value' src={Fourone} className="ALSFive-one" /></Link>
